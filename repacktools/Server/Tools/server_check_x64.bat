...
:start_login
start Server\Bin64\authserver.exe
goto login
...
if "%ERRORLEVEL%"=="0" echo Check pass && goto donation
...
:donation
ping -n 5 127.0.0.1>nul
REM start Server\Tools\SilentCMD.exe Server\Tools\worldserver-support.bat
