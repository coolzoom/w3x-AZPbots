@echo off
SET NAME=SingleCore-AC server launcher
TITLE %NAME%
COLOR C
set mod=%1
...
cls
echo ##############################################
echo # [SPP] AzerothCore tools.                   #
echo # https://github.com/conan513/SingleCore-AC  #
echo # ------------------------------------------ #
...
echo.
echo Importing character updates...
echo.
